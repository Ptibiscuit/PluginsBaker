...
public class mysqlCore {
	...
	public PreparedStatement prepareStatement(String sql) throws SQLException, IllegalAccessException, InstantiationException, MalformedURLException {
		return this.manageDB.getConnection().prepareStatement(sql);
	}
}